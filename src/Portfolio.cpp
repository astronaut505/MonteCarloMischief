...
{
    double price = 0.0;
    price -= downAndOutCall(S0, K1, r, T, sigma, barrierLevelDown);
    price += downAndOutCall(S0, K2, r, T, sigma, barrierLevelDown);
    price += upAndOutPut(S0, K3, r, T, sigma, barrierLevelUp);
    price -= upAndOutPut(S0, K4, r, T, sigma, barrierLevelUp);
    return price;
}
